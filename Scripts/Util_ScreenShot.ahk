...
CaptureErrorScreen:
	...
	FormatTime, StringerrorTimeStamp, %A_NOW%, MM-dd tt hh시mm분ss초
		/*
...
funcCaptureErrorScreen()
{
	 ...
	 */
	CaptureScreen(1, False, targetFile, 100)
   returnString:="ErrorSceenShot - ErrorShot_"StringerrorTimeStamp
   return returnString
}
...
CaptureScreen:
	...
	loopFileName:
		 ...
		 * Form the name of new file.
		 */
		newFileName := "ScreenShot\img_" countLoopString ".jpg"
...
CaptureScreen(aRect = 0, bCursor = False, sFile = "", nQuality = "")
{
   global ACTIVE_ID
	...
	Else If	aRect = 1
		WinGetPos, nL, nT, nW, nH, %ACTIVE_ID%
	Else If	aRect = 2
	{
		WinGet, hWnd, ID, %ACTIVE_ID%
